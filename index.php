...
<body>
	<?php if (isset($_SESSION['username'])) { ?>
		<div class="navbar navbar-fixed-top navbar-inverse">
		  	<div class="navbar-inner">
		    	...
		    	<ul class="nav">
		      		<li class="active"><a onClick="_gaq.push(['_trackEvent', 'Menu', 'Click', 'Home']);" href="/">home</a></li>
	...
	<?php } ?>
		...
		<section id="footer">
			...
			<a onClick="_gaq.push(['_trackEvent', 'Footer', 'Click', 'Login']);" class="clickable" href="/protected/"></a>
		</section>
	</div>
