            ...
            using (HostingEnvironment.Impersonate()) {
                using (DirectoryEntry de = new DirectoryEntry(
                    ...
                    using (DirectorySearcher adSearch = new DirectorySearcher(de)) {
                        ...
                        if (adSearchResult.Properties[UserProfileManager.USER_DISPLAY_NAME].Count == 0) {
                            adInfo[0] = "";
                        } else {
                            adInfo[0] = adSearchResult.
                                Properties[UserProfileManager.USER_DISPLAY_NAME][0].ToString();
                        }

                        if (adSearchResult.Properties[UserProfileManager.USER_EMAIL].Count == 0) {
                            adInfo[1] = "";
                        } else {
                            adInfo[1] = adSearchResult.
                                Properties[UserProfileManager.USER_EMAIL][0].ToString();
                        }
