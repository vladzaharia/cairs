...
namespace SasquatchCAIRS.Models.Common {
    ...
    public static class Constants {
        ...
        /// <summary>
        ///     Default header rown on report
        /// </summary>
        public const int REPORT_HEADER_ROW = 4;

        /// <summary>
        ///     Location where the Data Starts.
        /// </summary>
        public const int DATA_START_ROW = REPORT_HEADER_ROW + 1;
        ...
        /// <summary>
        ///     All of the gender options available.
        /// </summary>
        public static readonly Gender[] genderOptions = {
            Gender.Female, Gender.Male, Gender.Other
        };

        /// <summary>
        ///     All possible severity options available.
        /// </summary>
        ...
        /// <summary>
        ///     All Possible Consequence Options
        /// </summary>
        ...
        /// <summary>
        ///     All the titles for the DataTables.
        /// </summary>
        public static readonly string[] DATATABLE_TITLES = new string[13] {
            "General Report",
            "Avg Time Per Request Stratified by Geographical Region",
        ...
        /// <summary>
        ///     All Dropdown Tables available
        /// </summary>
        public static readonly DropdownTable[] DROPDOWN_TABLES =
            new DropdownTable[6] {
        ...
        public static class Export {
            ...
            public const string REQUEST_ATTACHMENT =
            ...
            public const string QUESTION_SPECIAL_NOTES =
                "Special Notes/Followup: ";
            ...
            // Header List
            public static readonly List<string> EXPORT_HEADERS =
                new List<string> {
                    REQUEST_INFORMATION,
